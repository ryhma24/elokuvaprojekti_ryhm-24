...
export async function addFavourite(favourite) {
    const result = await pool.query("INSERT INTO favourites (movieid, idaccount, ismovie) VALUES ($1, $2, $3) ON CONFLICT DO NOTHING", [favourite.movieId, favourite.idaccount, favourite.ismovie ])
    return result.rows;
}
